...
var app = (function () {
    ...
    const file$d = "src/WhoAreWe.svelte";
    ...
    function create_fragment$h(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h10, file$d, 5, 8, 67);
    			attr_dev(p0, "class", "svelte-111jsnk");
    			add_location(p0, file$d, 6, 8, 97);
    			attr_dev(p1, "class", "svelte-111jsnk");
    			add_location(p1, file$d, 12, 8, 334);
    			add_location(div0, file$d, 4, 4, 53);
    			attr_dev(h11, "class", "svelte-111jsnk");
    			add_location(h11, file$d, 17, 8, 445);
    			attr_dev(p2, "class", "svelte-111jsnk");
    			add_location(p2, file$d, 18, 8, 488);
    			attr_dev(p3, "class", "svelte-111jsnk");
    			add_location(p3, file$d, 21, 8, 571);
    			add_location(div1, file$d, 16, 4, 431);
    			attr_dev(div2, "class", "container flex svelte-111jsnk");
    			add_location(div2, file$d, 3, 0, 20);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$c = "src/Resume.svelte";
    ...
    function create_fragment$g(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file$c, 5, 8, 74);
    			attr_dev(div0, "class", "mt-3 title svelte-1g86ltu");
    			add_location(div0, file$c, 6, 8, 137);
    			attr_dev(div1, "class", "title svelte-1g86ltu");
    			add_location(div1, file$c, 7, 8, 180);
    			attr_dev(div2, "class", "col svelte-1g86ltu");
    			add_location(div2, file$c, 4, 4, 48);
    			...
    			add_location(img1, file$c, 10, 8, 242);
    			attr_dev(div3, "class", "mt-3 title svelte-1g86ltu");
    			add_location(div3, file$c, 11, 8, 306);
    			attr_dev(div4, "class", "title svelte-1g86ltu");
    			add_location(div4, file$c, 12, 8, 350);
    			add_location(div5, file$c, 9, 4, 228);
    			...
    			add_location(img2, file$c, 15, 8, 412);
    			attr_dev(div6, "class", "mt-3 title svelte-1g86ltu");
    			add_location(div6, file$c, 16, 8, 477);
    			attr_dev(div7, "class", "title svelte-1g86ltu");
    			add_location(div7, file$c, 17, 8, 524);
    			add_location(div8, file$c, 14, 4, 398);
    			attr_dev(div9, "class", "container svelte-1g86ltu");
    			add_location(div9, file$c, 3, 0, 20);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$b = "src/Solution.svelte";
    ...
    function create_fragment$f(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$b, 5, 2, 71);
    			attr_dev(div0, "class", "flex svelte-1x67tse");
    			add_location(div0, file$b, 4, 1, 50);
    			attr_dev(h1, "class", "svelte-1x67tse");
    			add_location(h1, file$b, 9, 3, 181);
    			attr_dev(p, "class", "svelte-1x67tse");
    			add_location(p, file$b, 10, 3, 206);
    			add_location(div1, file$b, 8, 2, 172);
    			attr_dev(div2, "class", "article svelte-1x67tse");
    			add_location(div2, file$b, 7, 1, 148);
    			attr_dev(div3, "class", "container flex svelte-1x67tse");
    			add_location(div3, file$b, 3, 0, 20);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$e(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file$a, 9, 4, 169);
    			attr_dev(h1, "class", "title svelte-1gqw02w");
    			add_location(h1, file$a, 10, 4, 218);
    			attr_dev(p, "class", "svelte-1gqw02w");
    			add_location(p, file$a, 11, 4, 252);
    			...
    			add_location(img1, file$a, 14, 12, 347);
    			attr_dev(a0, "href", /*linkedin*/ ctx[3]);
    			attr_dev(a0, "target", "_blank");
    			add_location(a0, file$a, 13, 8, 299);
    			...
    			add_location(img2, file$a, 17, 12, 464);
    			attr_dev(a1, "href", /*email*/ ctx[4]);
    			add_location(a1, file$a, 16, 8, 435);
    			attr_dev(div0, "class", "flex svelte-1gqw02w");
    			add_location(div0, file$a, 12, 4, 272);
    			attr_dev(div1, "class", "container svelte-1gqw02w");
    			add_location(div1, file$a, 8, 0, 141);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$9 = "src/Feedback.svelte";
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div0 = element("div");
    			div0.textContent = "This is such a great idea, I can't stand waiting in line !";
    			t1 = space();
    			div1 = element("div");
    			div1.textContent = "2";
    			t3 = space();
    			div2 = element("div");
    			div2.textContent = "3";
    			add_location(div0, file$9, 23, 4, 571);
    			add_location(div1, file$9, 24, 4, 645);
    			add_location(div2, file$9, 25, 4, 662);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$d(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$9, 18, 4, 447);
    			attr_dev(div, "class", "primary-container svelte-10bdzgz");
    			add_location(div, file$9, 17, 0, 411);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_default_slot_7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$5, 36, 4, 1331);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (!src_url_equal(img.src, img_src_value = "img/BannerWAITR.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "banner");
    			add_location(img, file$5, 45, 4, 1711);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		},
